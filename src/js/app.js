...
const app = {
  ...
  activatePage: function(pageId){
    ...
    for(let page of thisApp.pages){
      ...
      page.classList.toggle(classNames.pages.active,page.id==pageId);// jest to dokładnie to samo co powyzsze zakomentowane linijki, warunek mozesz uzyc jako drugi argument 
    }
